...
// `/`; the group-level fallback is now the neutral `app/(workspace)/loading.tsx`.
    ...
    <div className="relative h-14 md:hidden">
      <div className="-ml-snug flex h-14 w-[calc(100%+0.5rem)] min-w-0 overflow-hidden pr-12">
        {Array.from({ length: 6 }, (_, index) => (
          <div
            key={index}
            className="grid h-14 min-w-14 shrink-0 place-content-center place-items-center gap-0.5 px-snug"
          >
