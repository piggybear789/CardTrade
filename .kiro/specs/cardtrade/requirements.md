...
4b. WHERE a Trade includes a cash component, THE CardTrade_System SHALL require the receiving Trader to hold a provider-approved payout account before the offer may be made, and SHALL restrict the cash component to flowing from the proposing Trader to the Counterpart.
