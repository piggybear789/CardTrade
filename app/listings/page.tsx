...
/**
 * First paint is still server-rendered so a shared `/listings?category=` link
 * shows the right grid. After that, pills / sort / filters / paging stay on
 * the client so the page is not torn down on every click.
 */
