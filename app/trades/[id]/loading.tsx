...
//
// Streaming fallback for the trade contract room. Shows the shell chrome and a
// content-area skeleton that approximates the header + action card + detail
// panel layout, without fetching anything.
