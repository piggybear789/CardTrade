...
// canonical states maps to a label + tone, then renders through the shared
// <ContractStatusBadge/> so a trade's status is presented identically to a cash
// sale's and a deal's. This file owns only the Trade_State vocabulary.
