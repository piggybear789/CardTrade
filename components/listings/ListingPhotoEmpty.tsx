...
/**
 * Parchment empty photo — a card-shaped absence, not a broken-image slash.
...
export function ListingPhotoEmpty({
  ...
  return (
    <div
      className={cn(
        'flex h-full w-full flex-col items-center justify-center bg-parchment text-muted-foreground',
