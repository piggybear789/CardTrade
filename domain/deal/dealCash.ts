...
// `cash_amount_cents` on a deal settles through Pinch — never as physical cash
// at the meetup. Collateral (DittoEscrow / unverified stake) is a separate
// safety layer and is resolved by `dealCollateral.ts`.
//
// Lifecycle (mirrors Pinch charge-and-refund):
...
/** Inputs needed to decide whether a deal has a Pinch cash leg. */
 ...
 * through Pinch (not at the handover).
 */
...
/**
 * Resolve who pays and who receives for a deal's Pinch cash leg.
 *
